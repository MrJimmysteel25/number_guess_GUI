...
class GuessingGame(EasyFrame):
	...
	def __init__(self):
		...
		self.hintLabel = self.addLabel(text = "Guess a number in between 1 and 100", row = 0, column = 0, columnspan = 2, sticky = "NSEW")
	...
	# Definition of the next guess function
	def nextGuess(self):
	...
	def newGame(self):
		...
		self.magicNumber = random.randint(1, 100)
		self.count = 0
		self.hintLabel["text"] = "Guess a number in between 1 and 100"
